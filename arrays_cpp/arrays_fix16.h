/*
 * Author : shtsno24
 * Date : 2019-11-24 19:02:00.789241
 * Language : cpp
 *
 */
#pragma once
...
uint16_t DepthwiseConv2D_0_depth = 1, DepthwiseConv2D_0_height = 28, DepthwiseConv2D_0_width = 28;

uint16_t PointwiseConv2D_0_depth = 16, PointwiseConv2D_0_height = 28, PointwiseConv2D_0_width = 28;
...
uint16_t DepthwiseConv2D_1_depth = 16, DepthwiseConv2D_1_height = 14, DepthwiseConv2D_1_width = 14;

uint16_t PointwiseConv2D_1_depth = 8, PointwiseConv2D_1_height = 14, PointwiseConv2D_1_width = 14;
...
uint16_t DepthwiseConv2D_2_depth = 8, DepthwiseConv2D_2_height = 7, DepthwiseConv2D_2_width = 7;

uint16_t PointwiseConv2D_2_depth = 8, PointwiseConv2D_2_height = 7, PointwiseConv2D_2_width = 7;
...
uint16_t DepthwiseConv2D_3_depth = 8, DepthwiseConv2D_3_height = 14, DepthwiseConv2D_3_width = 14;

uint16_t PointwiseConv2D_3_depth = 16, PointwiseConv2D_3_height = 14, PointwiseConv2D_3_width = 14;
...
uint16_t DepthwiseConv2D_4_depth = 16, DepthwiseConv2D_4_height = 28, DepthwiseConv2D_4_width = 28;

uint16_t PointwiseConv2D_4_depth = 1, PointwiseConv2D_4_height = 28, PointwiseConv2D_4_width = 28;

uint16_t SeparableConv2D_4_depth = 1, SeparableConv2D_4_height = 28, SeparableConv2D_4_width = 28;


vector< int16_t> MemBank_A(14400);

vector< int16_t> MemBank_B(14400);
