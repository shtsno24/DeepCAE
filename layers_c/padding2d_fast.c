#include <stdint.h>
#include "padding2d_fast.h"
#include <stdio.h>

uint8_t padding2d_fix16_fast(uint16_t padding_height, uint16_t padding_width,
...
uint8_t padding2d_float32_fast(uint16_t padding_height, uint16_t padding_width,
